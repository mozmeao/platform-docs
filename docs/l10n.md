...
In short, once new translations land in the string-source repo (e.g. `github.com/mozilla-l10n/www-l10n`) they are cloned over to the activation-check repo `github.com/mozmeao/www-l10n/` by a CI task and later pulled into Bedrock from there.
